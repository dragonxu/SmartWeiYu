...
public class WaveProgressView extends View {
    ...
    private String WAVE_COLOR_GREEN = "#FF99E8D3";
    private String WAVE_COLOR_RED = "#FFFC98A5";

    private String TEXT_COLOR_GREEN = "#FF90FFC6";
    private String TEXT_COLOR_RED = "#FFFF4B6A";

    private static final String DEFAULT_WAVE_COLOR = "#FF00B395";   // 默认的波纹颜色
    private static final String DEFAULT_WAVE_BG_COLOR = "#FF99E8D3";    // 默认波纹背景色
    private static final String DEFAULT_TEXT_HINT_COLOR = "#FF90FFC6"; // 默认提示字体颜色
    private static final String DEFAULT_TEXT_COLOR = "#FF90FFC6";    // 默认字体颜色
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mProgress = ta.getInt(R.styleable.WaveProgressView_progress, 5);
...
//                    getMeasuredHeight() / 2 + baseLine - 10, mTextPaint);
//        }
        // 画提示
