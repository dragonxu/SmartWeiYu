...
public class HttpManage {
    ...
    // 欧唯
//    public static String COMPANY_ID = "100fa2b00e3f7600";
    // 酸奶机
    public static String COMPANY_ID = "1007d2ada2c3ba00";
    // gicisky
//    public static String COMPANY_ID = "1007d2ada2c3ba00";
    //    private final String host = "http://42.121.122.228:8887";
    private final String host = "http://api2.xlink.cn";
    //    private final String host = "http://ic.heiman.cn:8887";
    // url
...
//    public final String upgradeUrl = host + "/v1/user/device/version";
     ...
     * @param pwd  密码
     */
    public void registerUserByMail(String mail, String name, String pwd, String languageType,final ResultCallback callback) {
        ...
        params.put("source", "2");
        params.put("local_lang", languageType);
    ...
    public void getShareList(final ResultCallback callback) {
        ...
        headers.put("Access-Token", ControlService.accessToken);
     ...
     * @param mail 用户 邮箱
     */
    public void forgetPasswd(String mail,String languageType, final ResultCallback callback) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("email", mail);
        params.put("corp_id", COMPANY_ID);
        params.put("local_lang", languageType);
        // 可选值 zh-cn 中文、 en-us 英文
//        params.put("local_lang", "zh-cn");
//        params.put("local_lang", "en-us");
    ...
    /**
     * 设备管理员分享设备通过二维码
     * @param deviceId 要分享的设备ID
     * @param callback
     */
    public void shareDeviceByQrcode(int deviceId, final ResultCallback callback) {
//    	int shareTime = (60*60*24);// 1天
        int shareTime = (60*5);// 5分钟
        Map<String, String> params = new HashMap<String, String>();
        params.put("expire", shareTime+"");
     ...
     * @param userId userId
     */
    public void unSubscribe(String userId, int deviceId, final ResultCallback callback) {
...
//					JSONArray jsonArray = responseJson.optJSONArray("list");
//					if (jsonArray == null) {
//					}
//					else {
//						
