...
public class NetworkUtils {
    ...
    public static String[] nowData() {
        ...
        mHour = String.valueOf(c.get(Calendar.HOUR_OF_DAY));// Сʱ
        if (mHour.length() == 1)
            mHour = "0" + mHour;
...
//	    	Log.e("NetworkUtils", "getXORCheck�����У��᣺"+strV);
        return strV;
    }
    ...
    public static String getXORCheck(int[] args) {
        ...
        for (int i = 0; i < args.length; i++) {
            result = result ^ args[i];
//	    		 Log.e("NetworkUtils", "getXORCheck���������"+result);
        }
     ...
     * У���
     *
     * @param strData ��Ҫ����У��͵�16��������
     * @param length  У���λ��
     * @return �������У�������
     */
    public static byte[] SumCheck(String strData, int length) {

        byte[] msg0 = hexStringToBytes(strData);
    ...
    public static double selsiusToFahrenheit(double celsius) {
