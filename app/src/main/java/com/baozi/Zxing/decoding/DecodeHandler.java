...
import com.example.smartouwei.CaptureActivity;
	...
	private void decode(byte[] data, int width, int height) {
		...
		if (source == null) {
			...
			message.sendToTarget();
			 Log.e("DecodeHandler", "decode：source = "+source);
			activity.sendBroadcast(new Intent(BaseVolume.GET_CAMERA_ERROR));
			return;
		}
		...
		try {
			...
			activity.sendBroadcast(new Intent(BaseVolume.GET_CAMERA_OK));
