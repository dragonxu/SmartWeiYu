  ...
  public Rect getFramingRect() {
    ...
    if (framingRect == null) {
      ...
      if (screenResolution == null) {
    	  Log.e("CameraManager", "getFramingRect：screenResolution = "+screenResolution);
    	  context.sendBroadcast(new Intent(BaseVolume.GET_CAMERA_ERROR));
    ...
    context.sendBroadcast(new Intent(BaseVolume.GET_CAMERA_OK));
      //原生
