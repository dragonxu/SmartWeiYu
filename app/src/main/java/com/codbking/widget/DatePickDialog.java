...
public class DatePickDialog extends Dialog implements OnChangeLisener {
    ...
    private LinearLayout m_llTop,m_llBottom;
    ...
    public void setSimpleVer(boolean isSimple) {
    ...
    private void initView() {
        ...
        m_llBottom = (LinearLayout) findViewById(R.id.llBottom);
        ...
        if (isSimple) {
            m_llTop.setVisibility(View.GONE);
            m_llBottom.setVisibility(View.GONE);
        }
        else {
            m_llTop.setVisibility(View.VISIBLE);
            m_llBottom.setVisibility(View.VISIBLE);
        }
